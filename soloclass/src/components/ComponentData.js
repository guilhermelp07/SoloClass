export const pickerItems = [
    {key: 0, description: "0 - Nenhuma opção"},
    {key: 1, description: "1 - Excessiva"},
    {key: 2, description: "2 - Forte"},
    {key: 3, description: "3 - Acentuada"},
    {key: 4, description: "4 - Boa"},
    {key: 5, description: "5 - Moderada"},
    {key: 6, description: "6 - Imperfeita"},
